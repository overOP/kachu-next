...
export default function OwnerMessage() {
  ...
  return (
    <section ref={containerRef} className="relative py-24 lg:py-40 px-6 overflow-hidden bg-green-950 dark:bg-zinc-950">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-emerald-600/5 dark:bg-sky-500/5 skew-x-12 translate-x-20" />
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          <div className="owner-quote-mark text-8xl text-emerald-500/20 dark:text-sky-500/15 font-serif absolute -top-10 left-0 hidden lg:block">
            “
          </div>
          
          <span className="owner-text-reveal text-emerald-500 dark:text-sky-400 font-bold tracking-[0.4em] uppercase text-[11px] mb-6 block">
