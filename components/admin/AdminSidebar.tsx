...
import { FiGrid, FiHome, FiLayers, FiPackage, FiUsers } from "react-icons/fi";
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="flex w-full flex-col border-b border-emerald-100 bg-white dark:border-zinc-800 dark:bg-zinc-900 lg:h-screen lg:w-60 lg:shrink-0 lg:border-b-0 lg:border-r">
      ...
      <nav
        className="flex gap-1 overflow-x-auto px-2 py-4 lg:flex-1 lg:flex-col lg:overflow-visible lg:px-2"
        aria-label="Admin"
      >
