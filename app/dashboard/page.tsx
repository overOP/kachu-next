        ...
        <section className="p-6 ">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <ActionButton label="Add Factory" />
            </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[2fr_1fr] gap-6">
          <div className="bg-white rounded-[2rem] p-8 shadow-sm min-h-[320px] border border-gray-100">
            ...
            <p className="text-sm text-gray-500">
              Visualize your most popular categories here.
            </p>
            <CategoryDetails/>
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-6 shadow-sm min-h-[320px] border border-gray-100">
            ...
            <div className="flex flex-col gap-4">
              <ActivityItem
                ...
                title='New Product "Coke" added'
                time="2 hours ago"
              />
              <ActivityItem
                icon={Pencil}
                iconBgColor="bg-blue-300"
                title='New Factory "Nestle" details updated'
                time="2 hours ago"
              />
              <ActivityItem
                icon={Shapes}
                iconBgColor="bg-yellow-200"
                title='New Category "Skin Care" created'
                time="4 hours ago"
              />
            </div>
          </div>
