      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-2">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2d8c5f" strokeWidth="2.2">
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          <p className="text-[10px] uppercase tracking-widest font-bold">
            &copy; 2026 <span className="text-emerald-500">Kachu Kart</span>. All rights reserved.
          </p>
